...
# @dp.message_handler(commands=['moderator'], is__chat_admin=True)
...
# Нвчало диалога загрузки нового пункта меню
...
def register_handlers_admin(dp: Dispatcher):
    dp.register_message_handler(
        cm_start, commands=['Загрузить'], state=None)
    dp.register_message_handler(
    ...
    dp.register_message_handler(delete_item, commands=[
                                'Удалить'])
